    ...
    row.innerHTML = `
        <div class="col-md-3">
            <select class="form-select source-field">
                ...
                <option value="NPO_ProjNr">NPO_ProjNr</option>
                <option value="NPO_ProjName">NPO_ProjName</option>
                <option value="NPO_KDatum">NPO_KDatum</option>
                <option value="NPO_KSumme">NPO_KSumme</option>
                <option value="NPO_ADatum">NPO_ADatum</option>
                <option value="NPO_ASumme">NPO_ASumme</option>
                <option value="ADR_NAME">ADR_NAME</option>
                <option value="ADR_TEL">ADR_TEL</option>
                <option value="ADR_LAND">ADR_LAND</option>
                <option value="ADR_PLZ">ADR_PLZ</option>
                <option value="ADR_ORT">ADR_ORT</option>
                <option value="ADR_STREET">ADR_STREET</option>
                <option value="ADR_HOUSE_NUMBER">ADR_HOUSE_NUMBER</option>
                <option value="AKP_NAME">AKP_NAME</option>
                <option value="AKP_VORNAME">AKP_VORNAME</option>
                <option value="AKP_FUNKTION">AKP_FUNKTION</option>
                <option value="AKP_TEL">AKP_TEL</option>
                <option value="AKP_MAIL">AKP_MAIL</option>
                <option value="AKP_NR">AKP_NR</option>
                <option value="AKP_ANR_NR">AKP_ANR_NR</option>
                <option value="ANR_ANREDE">ANR_ANREDE</option>
                <option value="ANR_ANREDETEXT">ANR_ANREDETEXT</option>
